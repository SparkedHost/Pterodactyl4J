...
import com.sparkedhost.pterodactyl4j.application.entities.ApplicationDatabase;

/**
 * {@link PteroAction PteroAction} extension designed for the creation of
 * {@link ApplicationDatabase ApplicationDatabases}
 *
...
public interface ApplicationDatabaseCreationAction extends PteroAction<ApplicationDatabase> {
    ...
    /**
     * Sets the name for this {@link ApplicationDatabase ApplicationDatabase}.
     *
     ...
     *
     * @return The {@link ApplicationDatabaseCreationAction ApplicationDatabaseCreationAction}
     * instance, useful for chaining
     */
    ApplicationDatabaseCreationAction setName(String name);

    /**
     * Sets the remote connection string for this {@link ApplicationDatabase ApplicationDatabase}.
     *
     ...
     * {@link ApplicationDatabase ApplicationDatabase}.
     *
     * @param  id
     *         The host id
     *
     ...
     *
     * @param  host
     *         The {@link ApplicationDatabase.DatabaseHost DatabaseHost}
     *
     *
     * @return The {@link ApplicationDatabaseCreationAction ApplicationDatabaseCreationAction}
     * instance, useful for chaining
