 ...
 * {@link ClientDatabase ClientDatabases}
 *
...
public interface ClientDatabaseCreationAction extends PteroAction<ClientDatabase> {
    ...
    /**
     * Sets the name for this {@link ClientDatabase ClientDatabase}.
     *
     ...
     *
     * @return The {@link ClientDatabaseCreationAction ClientDatabaseCreationAction}
     * instance, useful for chaining
     */
    ClientDatabaseCreationAction setName(String name);

    /**
     * Sets the remote connection string for this {@link ClientDatabase ClientDatabase}.
     *
