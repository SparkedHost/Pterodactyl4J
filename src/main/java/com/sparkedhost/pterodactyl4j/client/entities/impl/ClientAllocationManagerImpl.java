...
import com.sparkedhost.pterodactyl4j.client.entities.ClientAllocation;
import com.sparkedhost.pterodactyl4j.client.entities.ClientServer;
import com.sparkedhost.pterodactyl4j.client.managers.ClientAllocationManager;
import com.sparkedhost.pterodactyl4j.requests.PteroActionImpl;
import com.sparkedhost.pterodactyl4j.requests.Route;
import org.json.JSONObject;

import static com.sparkedhost.pterodactyl4j.requests.PteroActionImpl.getRequestBody;
...
public class ClientAllocationManagerImpl implements ClientAllocationManager {
    ...
    public PteroAction<ClientAllocation> setNote(ClientAllocation allocation, String note) {
        ...
        return PteroActionImpl.onRequestExecute(impl.getP4J(),
                ...
                PteroActionImpl.getRequestBody(json), (response, request) -> new ClientAllocationImpl(response.getObject(), server));
    }
