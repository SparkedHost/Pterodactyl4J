...
import com.sparkedhost.pterodactyl4j.client.entities.File;
import com.sparkedhost.pterodactyl4j.client.entities.GenericFile;
import com.sparkedhost.pterodactyl4j.client.managers.CompressAction;
import com.sparkedhost.pterodactyl4j.client.managers.DeleteAction;
import com.sparkedhost.pterodactyl4j.client.managers.RenameAction;
    ...
    public List<GenericFile> getFiles() {
        ...
        for (Object o : json.getJSONArray("data")) {
            ...
            if (genericFile.isFile())
                files.add(new FileImpl(file, getPath(), server));
