...
package com.sparkedhost.pterodactyl4j.requests.action;
...
import com.sparkedhost.pterodactyl4j.utils.Procedure;
import com.sparkedhost.pterodactyl4j.utils.StreamUtils;
...
/**
 * {@link PteroAction PteroAction} specification used to retrieve entities for paginated endpoints.
...
public interface PaginationAction<T> extends PteroAction<List<T>>, Iterable<T> {
     ...
     * <br>Every {@link PteroAction PteroAction} success
     ...
     * retrieved by the iterator or a call to a {@link PteroAction PteroAction}
     ...
     *
     * @param  action
     *         {@link Procedure Procedure} returning {@code true} if iteration should continue
     *
     * @throws java.lang.IllegalArgumentException
     ...
     * request a List of new entities through internal calls of {@link PteroAction#executeAsync() PteroAction.executeAsync()}.
     ...
     *
     * @return {@link PteroAction PteroAction} - Type {@link java.util.List List} of {@link T &lt;T&gt;}
     */
     ...
     * request a List of new entities through a call of {@link PteroAction#execute() PteroAction.execute()}.
