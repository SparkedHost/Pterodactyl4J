...
import com.sparkedhost.pterodactyl4j.client.entities.Backup;
...
import com.sparkedhost.pterodactyl4j.client.entities.Schedule;
import com.sparkedhost.pterodactyl4j.client.managers.*;
import com.sparkedhost.pterodactyl4j.client.managers.*;
...
public enum Permission {
     ...
     *
     * @return The raw value of this {@link Permission}
     */
     ...
     *
     * @return The readable description of this {@link Permission}
     */
    ...
    /**
     * A set of all {@link Permission Permissions} that are specified by the collection of
     * raw permissions.
     *
     * @param  permissions
    ...
    /**
     * This is effectively the opposite of {@link #getPermissions(String...)}, this takes 1 or more {@link Permission Permissions}
     ...
     *
     * @return Never-empty String array representating the raw values of the {@link Permission Permissions}
     */
    ...
    /**
     * This is effectively {@link #getPermissions(String...)}, designed for returning a single {@link Permission Permission}
     *
     * @param  raw
     *         The raw representation of the permission
     *
     * @return Never-null {@link Permission Permission}.
     *
     */
